...
public class Topic_07_Textbox_TextArea {
	...
	String comment = "This is general data\nof real people";
	String firstName = "Thu Qua";
	String lastName = "Vo Thi";
	...
	public void TC_01_Create_New_Employee() {
		...
		//employeeIDTextbox.sendKeys(Keys.chord(Keys.CONTROL,"a")); --> dùng cho Window
		employeeIDTextbox.sendKeys(Keys.chord(Keys.COMMAND,"a")); //dùng cho Mac
		...
		driver.findElement(By.xpath("//label[text()='Username']/parent::div/following-sibling::div/input")).sendKeys("Thu Qua"+ employeeID);
	...
	public void TC_02_Verify_Employee() {
		driver.findElement(By.name("username")).sendKeys("Thu Qua"+ employeeID);
